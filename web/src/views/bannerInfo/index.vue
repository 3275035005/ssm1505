<template>
  <div>
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>轮播图广告信息</el-breadcrumb-item>
    </el-breadcrumb>
    ...
    <el-form :inline="true" :model="formInline" class="user-search">
      <el-form-item label="广告标题">
        <el-input clearable size="small" v-model="formInline.title" placeholder="请输入广告标题"></el-input>
      </el-form-item>
      <el-form-item label="广告状态">
        <el-select v-model="formInline.status" placeholder="请选择广告状态">
    ...
    <el-table size="small" :data="list" highlight-current-row v-loading="loading" border element-loading-text="拼命加载中" style="width: 100%;">
      ...
      <el-table-column align="center"  prop="image" label="广告封面">
        <template slot-scope="scope">
          <el-image
      ...
      <el-table-column align="center"  prop="url" label="广告链接" >
      </el-table-column>
      <el-table-column align="center"  prop="status" label="广告状态" >
        <template slot-scope="scope">
    ...
    <el-dialog
      ...
      <el-form label-width="120px" ref="editForm" :model="editForm" :rules="rules">
        <el-form-item label="广告标题" prop="title">
          <el-input size="small" v-model="editForm.title" auto-complete="off" placeholder="请输入广告标题"></el-input>
        </el-form-item>
        <el-form-item label="广告链接" prop="url">
          <el-input size="small" v-model="editForm.url" auto-complete="off" placeholder="请输入广告链接"></el-input>
        </el-form-item>
        <el-form-item label="广告状态" prop="status">
          <el-select v-model="editForm.status" placeholder="请选择广告状态">
            <el-option  label="上架" value="1"/>
            <el-option  label="下架" value="0"/>
          </el-select>
        </el-form-item>
...
<script>
// 导入请求方法
import {list,save,deleteById,update } from '@/api/bannerInfo'
