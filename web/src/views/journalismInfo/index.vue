<template>
  <div>
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>电影新闻资讯</el-breadcrumb-item>
    </el-breadcrumb>
    ...
    <el-table size="small" :data="list" highlight-current-row v-loading="loading" border element-loading-text="拼命加载中" style="width: 100%;">
      ...
      <el-table-column align="center"  prop="image" label="新闻封面">
        <template slot-scope="scope">
          <el-image
...
<script>
// 导入请求方法
import {list,save,deleteById,update } from '@/api/journalismInfo'
