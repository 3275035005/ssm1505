<template>
  <div>
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>电影亲情榜</el-breadcrumb-item>
    </el-breadcrumb>
    ...
    <el-form :inline="true" :model="formInline" class="user-search">
      <el-form-item label="电影名称">
        <el-select v-model="formInline.filmId" placeholder="请选择电影名称">
          <el-option v-for="item in filmInfoList" :label="item.title" :value="item.id"  :key="item.id"/>
        </el-select>
      </el-form-item>
      <el-form-item>
    ...
    <el-table size="small" :data="list" highlight-current-row v-loading="loading" border element-loading-text="拼命加载中" style="width: 100%;">
      ...
      <el-table-column align="center"  prop="title" label="电影标题" >
      </el-table-column>
    ...
    <el-dialog
      ...
      <el-form label-width="120px" ref="editForm" :model="editForm" :rules="rules">
        <el-form-item label="电影名称">
          <el-select v-model="editForm.filmId" placeholder="请选择电影名称">
            <el-option v-for="item in filmInfoList" :label="item.title" :value="item.id"  :key="item.id"/>
          </el-select>
        </el-form-item>
...
<script>
// 导入请求方法
import {list,save,deleteById,update } from '@/api/filmList'
import Pagination from '../../components/Pagination'
import {getFilmAll} from "@/api/filmInfo";
export default {
  // 注册组件
  components: {
    Pagination
