<template>
  <div>
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>电影分类信息</el-breadcrumb-item>
    </el-breadcrumb>
    ...
    <el-form :inline="true" :model="formInline" class="user-search">
      <el-form-item label="分类名称">
        <el-input clearable size="small" v-model="formInline.title" placeholder="请输入分类名称"></el-input>
      </el-form-item>
      <el-form-item>
    ...
    @click='closeDialog("edit")'>
      <el-form label-width="120px" ref="editForm" :model="editForm" :rules="rules">
        <el-form-item label="分类名称" prop="title">
          <el-input size="small" v-model="editForm.title" auto-complete="off" placeholder="请输入分类名称"></el-input>
        </el-form-item>
        <el-form-item label="分类排序" prop="sort">
          <el-input-number v-model="editForm.sort":min="1" :max="100"></el-input-number>
        </el-form-item>
      </el-form>
...
<script>
// 导入请求方法
import {list,save,deleteById,update } from '@/api/filmClassification'
