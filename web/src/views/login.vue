<template>
  <div class="login-wrap">
    <div style="text-align: center; margin-bottom: 30px; font-size: 30px">在线影院网址管理系统</div>
    ...
    <el-row :gutter="20" class="footer">
       <el-col :span="12" :offset="11"><div><span>Copyright © 2023  在线影院网址管理系统</span></div></el-col>
    </el-row>
  </div>
</template>
          ...
          login(this.ruleForm).then(res => {
            ...
            if (res.code === 200) {
              ...
              setTimeout(() => {
                this.logining = false
                // 缓存token
                localStorage.setItem('username', res.row.id);
                // 缓存用户个人信息
                localStorage.setItem('userdata', JSON.stringify(res.row))
                this.$store.commit('login', 'true')
                this.$router.push({ path: '/filmInfo/index' })
              }, 1000)
            } else {
